...
//================================================
void getJpsiWidthEmbed(int savePlot, int saveHisto)
{
...
//===============================================
void MLfit(const int isetup = 2, const int icent = 0, int savePlot = 0, int saveHisto = 0)
{
  gStyle->SetOptFit(0);
  ...
  for(int m=0; m<3; m++)
      ...
      for(int i=0; i<nPtBins; i++)
	{
	  ...
	  funcSignal[i][m]->SetLineWidth(0.5);
